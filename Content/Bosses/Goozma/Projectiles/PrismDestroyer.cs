        ...
        public override void AI()
        {
            ...
            for (int i = 0; i < Rays; i++)
            {
                ...
                if (Main.rand.NextBool(15))
                    Particle.NewParticle(ModContent.GetInstance<Particles.PrettySparkle>(), Projectile.Center, new Vector2(15 * Projectile.scale).RotatedBy(Projectile.rotation - MathHelper.PiOver4 + MathHelper.TwoPi / Rays * i).RotatedByRandom(0.3f), rayColor, 0.1f + Main.rand.NextFloat());
