...
namespace CalamityHunt.Content.Bosses.Goozma.Projectiles
{
    public class SlimeShot : ModProjectile, IDieWithGoozma
    {
        ...
        public override void AI()
        {
            ...
            {
                ParticleBehavior hue = ParticleBehavior.NewParticle(ModContent.GetInstance<HueLightDust>(), Projectile.Center + Main.rand.NextVector2Circular(20, 20), Projectile.velocity * 0.4f, Color.White, 1f);
        ...
        public override void Kill(int timeLeft)
        {
            for (int i = 0; i < 30; i++)
            {
                ParticleBehavior hue = ParticleBehavior.NewParticle(ModContent.GetInstance<HueLightDust>(), Projectile.Center, Main.rand.NextVector2Circular(6, 6), Color.White, 1f);
                hue.data = Projectile.localAI[0];
