...
namespace CalamityHunt.Content.Bosses.Goozma.Projectiles
{
    public class SlimeShot : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            Projectile.velocity = Vector2.Lerp(Projectile.velocity, Vector2.Zero, 0.0005f + Utils.GetLerpValue(50, 165, Time, true) * 0.05f) * (1f + 0.115f * Utils.GetLerpValue(50, 0, Time, true) * 0.5f);
            ...
            if (target > -1)
                Projectile.velocity = Vector2.Lerp(Projectile.velocity, Projectile.DirectionTo(Main.player[target].MountedCenter).SafeNormalize(Vector2.Zero) * Projectile.oldVelocity.Length(), 0.004f);
