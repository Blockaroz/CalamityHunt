    ...
    public class ConstellationLine : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Time > 95 && Time < 180 && Main.rand.NextBool(5))
                ParticleBehavior.NewParticle(ModContent.GetInstance<PrettySparkle>(), Vector2.Lerp(Main.projectile[(int)Start].Center, Main.projectile[(int)End].Center, Main.rand.NextFloat()), Main.rand.NextVector2Circular(1, 1), new Color(30, 15, 10, 0), (0.2f + Main.rand.NextFloat()));
