    ...
    public class CometKunaiProjectile : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            else
            {
                ...
                {
                    ParticleBehavior.NewParticle(ModContent.GetInstance<CrossSparkle>(), Projectile.Center, MathHelper.PiOver4.ToRotationVector2(), new Color(50, 180, 255, 0), 1f);
                    ParticleBehavior.NewParticle(ModContent.GetInstance<CrossSparkle>(), Projectile.Center, Vector2.Zero, new Color(50, 180, 255, 0), 0.5f);
                }
            }
        }
