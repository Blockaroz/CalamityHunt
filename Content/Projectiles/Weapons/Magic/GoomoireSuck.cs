...
namespace CalamityHunt.Content.Projectiles.Weapons.Magic
{
    public class GoomoireSuck : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            ParticleBehavior.NewParticle(ModContent.GetInstance<HueLightDust>(), Projectile.Center + inward, -inward * 0.03f, glowColor, 1f + Main.rand.NextFloat());
        ...
        public void Poof()
        {
            ...
            for (int i = 0; i < 5; i++)
                ParticleBehavior.NewParticle(ModContent.GetInstance<HueLightDust>(), Projectile.Center, Main.rand.NextVector2Circular(3, 3), glowColor, 2f);
