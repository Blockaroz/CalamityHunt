    ...
    public class CrystalGauntletBall : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if ((Time - 8) % 4 == 1)
            {
                ...
                ParticleBehavior.NewParticle(ModContent.GetInstance<CrossSparkle>(), Projectile.Center + Projectile.velocity * 5f + Main.rand.NextVector2Circular(16, 16), Vector2.Zero, Main.hslToRgb(Time * 0.03f % 1f, 0.5f, 0.5f, 128), 0.5f + Main.rand.NextFloat());
