...
namespace CalamityHunt.Content.Items.Weapons.Summoner
{
    public class Gobflogger : ModItem
    {
        ...
        {
            Item.DefaultToWhip(ModContent.ProjectileType<GobfloggerProj>(), 2000, 2f, 4f, 35);
            Item.shootSpeed = 4;
        ...
        public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float scale, int whoAmI)
        {
            ...
            Color glowColor = Color.CornflowerBlue;
            glowColor.A /= 2;
            spriteBatch.Draw(glow, Item.Center, glow.Frame(), glowColor, rotation, Item.Size * 0.5f, scale, 0, 0);
        }
