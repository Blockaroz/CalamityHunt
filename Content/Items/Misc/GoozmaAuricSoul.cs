...
namespace CalamityHunt.Content.Items.Misc
{
    public class GoozmaAuricSoul : ModItem
    {
        ...
        public override bool PreDrawInInventory(SpriteBatch spriteBatch, Vector2 position, Rectangle frame, Color drawColor, Color itemColor, Vector2 origin, float scale)
        {
            ...
            Color glowColor = GetAlpha(Color.White).Value;
            glowColor.A = 0;
            spriteBatch.Draw(glowTexture, position, glowTexture.Frame(), glowColor * 0.1f, 0, glowTexture.Size() * 0.5f, scale * 0.5f, 0, 0);
            spriteBatch.Draw(glowTexture, position, glowTexture.Frame(), glowColor, 0, glowTexture.Size() * 0.5f, scale * 0.17f, 0, 0);
