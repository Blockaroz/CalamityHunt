...
public class FlyingSlimerParticleBehavior : FlyingSlimeParticleBehavior
{
    ...
    public override void PostUpdate(in Entity entity)
    {
        ...
        Dust slime = Dust.NewDustPerfect(position.Value + Main.rand.NextVector2Circular(20, 20), DustID.Corruption, velocity.Value * 0.5f, 200, color.Value, 0.5f + Main.rand.NextFloat());
