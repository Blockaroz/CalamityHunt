...
namespace CalamityHunt.Content.Particles
{
    public class CrossSparkle : Particle
    {
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            drawColor.A = 0;
            spriteBatch.Draw(texture, position - Main.screenPosition, texture.Frame(), color * 0.4f, rotation - MathHelper.PiOver4, texture.Size() * 0.5f, power * new Vector2(0.25f, 0.8f), 0, 0);
            spriteBatch.Draw(texture, position - Main.screenPosition, texture.Frame(), color * 0.4f, rotation + MathHelper.PiOver4, texture.Size() * 0.5f, power * new Vector2(0.25f, 0.8f), 0, 0);
            spriteBatch.Draw(texture, position - Main.screenPosition, texture.Frame(), drawColor, rotation - MathHelper.PiOver4, texture.Size() * 0.5f, power, 0, 0);
            spriteBatch.Draw(texture, position - Main.screenPosition, texture.Frame(), drawColor, rotation + MathHelper.PiOver4, texture.Size() * 0.5f, power, 0, 0);
