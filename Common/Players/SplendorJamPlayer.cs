    ...
    public class SplendorJamPlayer : ModPlayer
    {
        ...
        public override void DrawEffects(PlayerDrawSet drawInfo, ref float r, ref float g, ref float b, ref float a, ref bool fullBright)
        {
            ...
            if (drawInfo.shadow == 0 && Main.rand.NextBool(8) && stressedOut)
                ParticleBehavior.NewParticle(ModContent.GetInstance<HueLightDust>(), Player.Center + Main.rand.NextVector2Circular(30, 40), Main.rand.NextVector2Circular(1, 1) - Vector2.UnitY * 3f, goo, 1f);
        }
